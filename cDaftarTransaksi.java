...
public class cDaftarTransaksi {
    ...
    public void lihatTotalBelanjaMember() {
        ...
        System.out.println("1. Budi [10] : " + Math.round(totalID10));
        System.out.println("2. Aji  [11] : " + Math.round(totalID11));
        System.out.println("3. Iwan [12] : " + Math.round(totalID12));
    }
    public void lihatGrafikPenjualan() {
        ...
        if (Math.round(brg1) < 10000) {
            System.out.println(" " + Math.round(brg1));
        } else {
        ...
        if (Math.round(brg2) < 10000) {
            System.out.println(" " + Math.round(brg2));
        } else {
        ...
        if (Math.round(brg3) < 10000) {
            System.out.println(" " + Math.round(brg3));
        } else {
        ...
        if (Math.round(brg4) < 10000) {
            System.out.println(" " + Math.round(brg4));
        } else {
        ...
        if (Math.round(brg5) < 10000) {
            System.out.println(" " + Math.round(brg5));
        } else {
