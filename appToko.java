...
public class appToko {
    public static void main(String[] args) {
        ...
        cBarang brg4 = new cBarang("Baju", 35000);
        cBarang brg5 = new cBarang("Topi", 12000);
                    ...
                    do {
                        ...
                        switch (pilih2) {
                            case 1:
                                ...
                                System.out.println("1. Tas      [" + brg1.getHarga() + "]");
                                System.out.println("2. Sandal   [" + brg2.getHarga() + "]");
                                System.out.println("3. Sepatu   [" + brg3.getHarga() + "]");
                                System.out.println("4. Baju     [" + brg4.getHarga() + "]");
                                System.out.println("5. Topi     [" + brg5.getHarga() + "]");
                                System.out.print("Pilih  = ");
                                pilih3 = sc.nextInt();
                ...
                case 4:
                    ...
                    if (pass == passPemilik) {
                        do {
                            ...
                            System.out.println("1. Laporan Penjualan Toko/Warung");
                            ...
                            if (pilih2 == 1) {
                                ...
                                System.out.println("Grafik Penjualan Toko");
